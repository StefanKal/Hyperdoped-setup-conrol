...
%detector, and detector_name is now a field which is either 'orion',
%'nova', or 'peltierMCT'
...
fp = 'C:\QCL1\Stefan\Samples\Eos29\Eos29_D2\LIV\'; %where to save the data, should end in '\'
fname = 'Eos29D2_p6_L11_100ns_10kHz_RT_LIV'; %do not include the .mat at the end
...
detector_name = 'orion'; %choose from 'nova','orion','peltierMCT'
